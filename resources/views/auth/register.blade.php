                ...
                <div class="w-full max-w-sm px-4 py-6 space-y-6 bg-white rounded-md dark:bg-darker">
                    ...
                    <form action="{{ route('register') }}" method="post" class="space-y-6">
                        ...
                        <input
                            ...
                            <input
                            class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker"
                            type="text" name="address" value="{{ old('address') }}" placeholder="address"
                            required />
                            <input
                            class="w-full px-4 py-2 border rounded-md dark:bg-darker dark:border-gray-700 focus:outline-none focus:ring focus:ring-primary-100 dark:focus:ring-primary-darker"
                            type="text" name="contact" value="{{ old('contact') }}" placeholder="contact"
                            required />
                        @error('name')
                            <div class="text-red-500 mt-2 text-sm"  style="color: white;background-color:red; padding:4px ">
                                {{$message}}
                            </div>
                        @enderror
                        <input
